// Set this to your hosted backend base URL when serving the UI from a static host (e.g., GitHub Pages).
// Example: window.__API_BASE__ = 'https://product-copier.onrender.com';
